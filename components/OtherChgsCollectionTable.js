...
const OtherChgsCollectionTable = () => {
  const data = [
    // Sample data - replace with actual data from API
    { sno: 1, receiptNo: 'OC001', date: '2024-07-26', custName: 'John Doe', loanNo: 'L001', amount: 500 },
    { sno: 2, receiptNo: 'OC002', date: '2024-07-26', custName: 'Jane Smith', loanNo: 'L002', amount: 750 },
  ];

  return (
    <div className="animate-fade-in-up mt-8 max-w-5xl mx-auto bg-white rounded-3xl shadow-2xl p-10 border border-gray-200">
      <h2 className="text-2xl font-bold text-blue-900 mb-6">Other Charges Collection Details</h2>
...
export default OtherChgsCollectionTable; 