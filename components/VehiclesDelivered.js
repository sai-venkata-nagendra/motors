...
import VehiclesFinancedReport from './VehiclesFinancedReport';
...
const VehiclesDelivered = () => {
  ...
  const [hpName, setHpName] = useState('All Vehicles');
  ...
  return (
    <>
      ...
      {showReport && <VehiclesFinancedReport />}
    </>
  );
};

export default VehiclesDelivered; 