      ...
      <div className="animate-fade-in-up max-w-5xl mx-auto bg-gradient-to-br from-blue-100 via-white to-teal-100 rounded-3xl shadow-2xl p-10 mt-10 border border-blue-200 relative backdrop-blur-xl bg-opacity-80">
        ...
        <div className="mt-8 flex items-center">
            <input
                ...
                id="showBreakup"
                checked={showBreakup}
                onChange={() => setShowBreakup(!showBreakup)}
                className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
            />
            <label htmlFor="showBreakup" className="ml-2 text-md font-medium text-gray-800">
                Show Principle & Interest Break-up
            </label>
        </div>

        <div className="mt-12 flex items-center justify-end gap-4 border-t-2 border-gray-200 pt-8">
            <button
