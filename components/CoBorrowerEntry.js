...
const CoBorrowerEntry = () => {
  ...
  return (
    <div className="animate-fade-in-up max-w-5xl mx-auto bg-gradient-to-br from-blue-100 via-white to-teal-100 rounded-3xl shadow-2xl p-10 mt-10 border border-blue-200 relative backdrop-blur-xl bg-opacity-80">
      <h2 className="text-4xl font-extrabold mb-10 text-blue-900 border-b-4 border-teal-200 pb-4 tracking-wider drop-shadow-lg text-center uppercase">New Co-Borrower Entry</h2>
      <form className="space-y-10">
        <div className="flex flex-wrap gap-10 items-end">
          ...
          <div className="flex-1 grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" value="101-CB-004149" disabled className="w-full border border-blue-200 rounded px-3 py-2 bg-blue-50 text-blue-900 font-bold" />
            </div>
            ...
            <div>
              <label className="block text-blue-900 font-semibold mb-1">Co-Borrower Type</label>
              <select name="coBorrowerType" value={form.coBorrowerType} onChange={handleInput} className="w-full border border-blue-200 rounded px-3 py-2">
                <option>New</option>
                <option>Existing</option>
              </select>
            </div>
            <div className="col-span-2 flex gap-2">
              <select name="coBorrowerTitle" value={form.coBorrowerTitle} onChange={handleInput} className="border border-blue-200 rounded px-2 py-2">
                <option>Mr.</option>
                <option>Ms.</option>
                <option>Mrs.</option>
              </select>
              <input name="coBorrowerName" value={form.coBorrowerName} onChange={handleInput} placeholder="Co-Borrower Name" className="flex-1 border border-blue-200 rounded px-3 py-2" />
        ...
        <div className="flex flex-wrap gap-4 justify-center mt-10">
          ...
          <button type="button" className="bg-gradient-to-r from-blue-500 to-blue-300 hover:from-blue-600 hover:to-blue-400 text-white font-bold px-8 py-3 rounded-xl shadow-lg border-2 border-blue-700 transition-all duration-200 text-lg">Save and Go to Customer Entry</button>
        </div>
      </form>
      <style jsx>{`
