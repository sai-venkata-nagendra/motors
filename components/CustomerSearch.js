...
const CustomerSearch = () => {
  ...
  const handleClear = () => {
    setForm({ searchBy: 'Customer Name', searchText: '' });
  };
  ...
  return (
    <>
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8 mt-8">
        <h2 className="text-2xl font-bold mb-8 text-blue-900 border-b pb-2 tracking-wide">Customer Search</h2>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 transition-opacity">
          <div className="bg-gray-100 rounded-2xl shadow-2xl p-8 w-full max-w-2xl border-2 border-blue-300 relative animate-fade-in">
            <h3 className="text-xl font-bold text-blue-900 mb-6 underline">Search Customer</h3>
